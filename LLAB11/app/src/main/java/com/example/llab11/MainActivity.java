    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_query.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                c.moveToFirst();
                items.clear();
                Toast.makeText(MainActivity.this,"共有"+c.getCount()+"筆資料",Toast.LENGTH_LONG).show();
            ...
            public void onClick(View view) {
                if(ed_book.length()<1||ed_price.length()<1) {
                    ...
                    try{
                        ...
                        Toast.makeText(MainActivity.this,"新增書名"+ed_book.getText().toString()+"價格"+ed_price.getText().toString(),Toast.LENGTH_LONG).show();
                        ed_price.setText("");
                        ed_book.setText("");
                    }catch(Exception e){
            ...
            public void onClick(View view) {
                if(ed_book.length()<1||ed_price.length()<1){
                    ...
                    try{
                        ...
                        Toast.makeText(MainActivity.this,"更新書名"+ed_book.getText().toString()+"價格"+ed_price.getText().toString(),Toast.LENGTH_LONG).show();
                        ed_price.setText("");
                        ed_book.setText("");
                    }catch(Exception e){
            ...
            public void onClick(View view){
                if(ed_book.length()<1){
                    ...
                    try{
                        ...
                        Toast.makeText(MainActivity.this,"刪除書名"+ed_book.getText().toString()+"價格"+ed_price.getText().toString(),Toast.LENGTH_LONG).show();
                        ed_price.setText("");
                        ed_book.setText("");
                    }catch(Exception e){
